...
function Header({ lang = "en", setLang }) {
  ...
  const navLink =
    "text-white hover:text-yellow px-4 py-2 rounded-md transition-colors duration-200 font-medium";
  const activeNavLink =
    "text-yellow bg-navy-dark px-4 py-2 rounded-md font-medium";

  return (
    <header
      className="w-full fixed top-0 left-0 z-50"
      style={{ backgroundColor: "rgb(4, 22, 41)" }}
    >
      ...
      {open && (
        <div className="md:hidden border-t border-yellow bg-navy-dark shadow-lg">
          <div className="px-4 py-3 space-y-1">
            <a
              href="#properties"
              className="block px-3 py-2 text-white hover:bg-yellow hover:text-navy rounded-md font-medium transition-colors duration-200"
            >
              Properties
            </a>
            <a
