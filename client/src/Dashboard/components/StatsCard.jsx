...
const StatsCard = ({ title, value, description, cardColor }) => (
  <div className={`rounded-2xl shadow-xl p-8 flex flex-col items-center justify-center border-2 border-yellow-400 transition-transform duration-200 hover:scale-105 hover:shadow-2xl cursor-pointer ${cardColor || 'bg-white'}`}>
